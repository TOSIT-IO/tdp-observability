...
def tdp_banner(title, subtitle):
    print(colored('#'+' '*79, 'cyan', 'on_white'))
    print(colored('#{: ^79}'.format(' '.join(title.upper())), 'black', 'on_white', attrs=["bold"]))
    print(colored('#'+' '*79, 'cyan', 'on_white'))
    ...
    print(colored("#                                 %%%%.         %%%%%%%%%%  %%%%.               ",'black', 'on_white'))
    print(colored('#'+' '*79, 'cyan', 'on_white'))
    print(colored('#'+' '*9+'{: <70s}'.format(subtitle), 'blue', 'on_white', attrs=["bold"]))
    print(colored('#'+' '*79, 'cyan', 'on_white'))
